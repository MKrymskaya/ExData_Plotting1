...
plot4 <- function(){
	...
	plot( time_series[,1], data$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power" )

	## create top-right plot
	plot( time_series[,1], data$Voltage, type = "l", xlab = "datetime", ylab = "Voltage" )
	...
	## create top-left plot
	plot( time_series[,1], data$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power" )
